import require$$1, { useState, useEffect } from "react";
import require$$2 from "react-dom";
import { Link, NavLink, Outlet, useParams, useNavigate, HashRouter, Routes, Route } from "react-router-dom";
import { Settings, X, Menu, ArrowRight, Target, Hammer, Flag, Loader2, AlertCircle, Calendar, Mail, CheckCircle, Send, ArrowLeft, Database, Github } from "lucide-react";
...
const Layout = ({ onOpenSettings }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-stone-50 font-sans text-stone-800", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-stone-200 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between h-16 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center space-x-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 bg-golf-600 rounded-full flex items-center justify-center text-white font-bold font-serif border-2 border-golf-800 shadow-inner", children: "9" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold font-serif text-golf-900 tracking-tight", children: "Backyard 9" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex space-x-8 items-center", children: [
          navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            NavLink,
            {
              to: link.path,
              className: ({ isActive }) => `text-sm font-medium transition-colors duration-200 ${isActive ? "text-golf-700 border-b-2 border-golf-600" : "text-stone-600 hover:text-golf-600"}`,
              children: link.name
            },
            link.name
          )),
      ...
      isMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-white border-b border-stone-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 pt-2 pb-3 space-y-1 sm:px-3", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        NavLink,
        {
          to: link.path,
          onClick: () => setIsMenuOpen(false),
          className: ({ isActive }) => `block px-3 py-2 rounded-md text-base font-medium ${isActive ? "bg-golf-50 text-golf-700" : "text-stone-600 hover:text-golf-600 hover:bg-stone-50"}`,
          children: link.name
        },
        link.name
      )) }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-stone-900 text-stone-400 py-8 border-t border-stone-800", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 md:mb-0 text-center md:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-lg text-stone-200", children: "Backyard 9" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1 text-stone-500 max-w-md", children: "Tee Time in a Tiny Space: A dad's guide to building the backyard golf simulator." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-6 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:fastegg@gmail.com", className: "hover:text-white transition-colors", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-stone-600", children: [
          "© ",
...
const Home = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-golf-900 text-white overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "h-full w-full", viewBox: "0 0 100 100", preserveAspectRatio: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0 100 C 20 0 50 0 100 100 Z", fill: "#22c55e" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[url('https://images.unsplash.com/photo-1587174486073-ae5e5cff23aa?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-30 mix-blend-overlay" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 flex flex-col items-center text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl md:text-6xl font-serif font-bold tracking-tight mb-6 drop-shadow-lg", children: [
          "Welcome to the ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-golf-400", children: "Backyard 9" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl md:text-2xl text-stone-200 max-w-2xl mb-10 font-light", children: "Tee Time in a Tiny Space: A dad's guide to building the backyard golf simulator." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-20 bg-stone-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/goals", className: "group p-8 bg-white rounded-2xl shadow-sm border border-stone-100 hover:shadow-md hover:border-golf-200 transition-all", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-golf-100 rounded-xl flex items-center justify-center text-golf-600 mb-6 group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 24 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-serif font-bold text-stone-900 mb-3 group-hover:text-golf-700", children: "The Goals" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-stone-600", children: "Understanding the vision. From drainage solutions to green speeds, see what we are aiming to achieve." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/building", className: "group p-8 bg-white rounded-2xl shadow-sm border border-stone-100 hover:shadow-md hover:border-golf-200 transition-all", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-golf-100 rounded-xl flex items-center justify-center text-golf-600 mb-6 group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Hammer, { size: 24 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-serif font-bold text-stone-900 mb-3 group-hover:text-golf-700", children: "The Build" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-stone-600", children: "Blood, sweat, and bentgrass. Follow the construction progress with weekly updates and photos." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/playing", className: "group p-8 bg-white rounded-2xl shadow-sm border border-stone-100 hover:shadow-md hover:border-golf-200 transition-all", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-golf-100 rounded-xl flex items-center justify-center text-golf-600 mb-6 group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { size: 24 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-serif font-bold text-stone-900 mb-3 group-hover:text-golf-700", children: "The Course" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-stone-600", children: "The final result. Course layout, scorecard, and local rules for the Backyard 9." })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border-t border-stone-200 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-serif font-bold text-stone-900 mb-6", children: "Want to get in touch?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-stone-600 mb-8", children: "Have questions about turf management, irrigation, or just want to say hi?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/contact",
...
const CACHE_DURATION = 1e3 * 60 * 15;
...
const parsePost = (filename, rawContent) => {
...
const MarkdownRenderer = ({ content }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose prose-stone prose-lg max-w-none prose-headings:font-serif prose-headings:text-golf-900 prose-a:text-golf-600 hover:prose-a:text-golf-700 prose-img:rounded-xl prose-img:shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ReactMarkdown, { children: content }) });
};
const SectionPage = ({ title, category, mode, subtitle, config }) => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    setError(null);
    fetchPosts(config).then((fetchedPosts) => {
      if (!isMounted) return;
      const filtered = fetchedPosts.filter(
        (p) => {
          var _a;
          return ((_a = p.metadata.category) == null ? void 0 : _a.toLowerCase()) === category.toLowerCase();
        }
      );
      setPosts(filtered);
    }).catch((err) => {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-[50vh] flex flex-col items-center justify-center text-stone-400", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Loader2, { className: "animate-spin h-10 w-10 mb-4 text-golf-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Loading the greens..." })
    ] });
  }
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto py-20 px-4 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 rounded-full bg-red-100 text-red-600 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AlertCircle, { size: 32 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-stone-900 mb-2", children: "Oops! Handshake Problem." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-stone-600 mb-6", children: error }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-stone-500", children: "Make sure your GitHub settings are correct in the config menu." })
    ] });
  }
  if (posts.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-20 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-serif font-bold text-stone-900 mb-4", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-stone-600 max-w-2xl mx-auto mb-10", children: subtitle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-10 bg-stone-100 rounded-xl inline-block", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-stone-500 font-medium", children: "No posts found in this section yet." }),
  ...
  if (mode === "single") {
    const post = posts[0];
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white min-h-screen pb-20", children: [
      post.metadata.image && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full h-64 md:h-96 bg-stone-200 overflow-hidden relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-8 max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl font-serif font-bold text-white drop-shadow-md mb-2", children: post.metadata.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center text-white/90 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { size: 16, className: "mr-2" }),
            new Date(post.metadata.date).toLocaleDateString(void 0, {
              year: "numeric",
              month: "long",
              day: "numeric"
            })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 py-12", children: [
        !post.metadata.image && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 border-b border-stone-200 pb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl font-serif font-bold text-golf-900 mb-4", children: post.metadata.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center text-stone-500 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { size: 16, className: "mr-2" }),
            new Date(post.metadata.date).toLocaleDateString(void 0, {
              year: "numeric",
              month: "long",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(MarkdownRenderer, { content: post.content })
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-16 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl font-serif font-bold text-golf-900 mb-6", children: title }),
      subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-stone-600 max-w-2xl mx-auto", children: subtitle })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: posts.map((post) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "article",
      {
        ...
        children: [
          post.metadata.image && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-48 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: post.metadata.image,
              alt: post.metadata.title,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex flex-col flex-grow", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center text-xs text-stone-400 mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { size: 14, className: "mr-1" }),
              new Date(post.metadata.date).toLocaleDateString()
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-serif font-bold text-stone-900 mb-3 leading-tight", children: post.metadata.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-stone-600 text-sm line-clamp-3 mb-4 flex-grow", children: post.metadata.excerpt || post.content.substring(0, 150) + "..." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
...
const Contact = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 rounded-full bg-golf-100 text-golf-600 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 32 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-serif font-bold text-stone-900 mb-4", children: "Get in Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-stone-600", children: "Questions about the build? Want to trade tips on bentgrass maintenance? Send me a message." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl shadow-xl p-8 border border-stone-100 relative overflow-hidden", children: isSubmitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-white flex flex-col items-center justify-center p-8 text-center animate-in fade-in duration-500", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 bg-green-100 rounded-full flex items-center justify-center text-green-600 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { size: 40 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-serif font-bold text-stone-900 mb-2", children: "Message Sent!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-stone-600 mb-8", children: "Thanks for reaching out. I'll get back to you as soon as I finish the next round." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "name", className: "block text-sm font-semibold text-stone-700 mb-1", children: "Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "email", className: "block text-sm font-semibold text-stone-700 mb-1", children: "Email" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "email",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "message", className: "block text-sm font-semibold text-stone-700 mb-1", children: "Message" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            id: "message",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs text-stone-400 mt-4", children: [
        "Alternatively, email me directly at ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:fastegg@gmail.com", className: "text-golf-600 hover:underline", children: "fastegg@gmail.com" })
      ] })
    ] }) })
  ] }) });
};
const PostDetail = ({ config }) => {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Loader2, { className: "animate-spin text-golf-600 w-10 h-10" }) });
  }
  if (!post) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 py-20 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-stone-900", children: "Post not found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => navigate(-1), className: "mt-4 text-golf-600 hover:underline", children: "Go Back" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "bg-white min-h-screen pb-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-stone-50 border-b border-stone-200 mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: () => navigate(-1),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 16, className: "mr-2" }),
            " Back to list"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl md:text-5xl font-serif font-bold text-golf-900 mb-4 leading-tight", children: post.metadata.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center text-stone-500 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { size: 16, className: "mr-2" }),
        new Date(post.metadata.date).toLocaleDateString(void 0, {
          year: "numeric",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-3 text-stone-300", children: "|" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "uppercase tracking-wide text-xs font-semibold text-golf-600", children: post.metadata.category })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4", children: [
      post.metadata.image && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: post.metadata.image,
          alt: post.metadata.title,
...
const SettingsModal = ({ isOpen, onClose, config, onSave }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[60] flex items-center justify-center p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 border-b border-stone-100 flex justify-between items-center bg-stone-50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-serif font-bold text-golf-900", children: "Data Source Settings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "text-stone-400 hover:text-stone-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 20 }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-stone-500", children: "Configure where the blog posts are loaded from. You can use the built-in demo data or connect a public GitHub repository." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center space-x-3 p-3 border rounded-lg cursor-pointer transition-colors hover:bg-stone-50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "radio",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Database, { size: 18, className: "text-stone-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-stone-700", children: "Use Demo Data" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center space-x-3 p-3 border rounded-lg cursor-pointer transition-colors hover:bg-stone-50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { size: 18, className: "text-stone-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-stone-700", children: "Use GitHub Repository" })
            ] })
          ] })
        ] }),
        !useDemo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-2 animate-in fade-in slide-in-from-top-2 duration-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-stone-500 uppercase tracking-wider mb-1", children: "GitHub Username" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-stone-500 uppercase tracking-wider mb-1", children: "Repository Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-stone-500 uppercase tracking-wider mb-1", children: "Path to Posts" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-stone-400 mt-1", children: "Directory containing your .md files" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 border-t border-stone-100 bg-stone-50 flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: handleSave,
...
const App = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(HashRouter, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Routes, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { onOpenSettings: () => setIsSettingsOpen(true) }), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "post/:category/:slug", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PostDetail, { config }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SettingsModal,
      {
...
root.render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(require$$1.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) })
);
